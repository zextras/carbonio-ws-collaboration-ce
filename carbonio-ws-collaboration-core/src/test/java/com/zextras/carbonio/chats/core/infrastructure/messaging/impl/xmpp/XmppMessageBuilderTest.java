  ...
  void buildMessageWithBody() {
    String hoped =
        "<message xmlns='jabber:client' from='sender-id' to='recipient-id' type='groupchat'><body"
            + " encoded='UTF-8'>this is my body !</body>"
            + "</message>";
    String result =
