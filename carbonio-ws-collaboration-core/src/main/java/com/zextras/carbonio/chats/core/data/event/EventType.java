...
public enum EventType {
  ...
  MEETING_WAITING_PARTICIPANT_JOINED,
  MEETING_WAITING_PARTICIPANT_CLASHED,
  MEETING_WAITING_PARTICIPANT_ACCEPTED,
  MEETING_WAITING_PARTICIPANT_REJECTED,
  MEETING_PARTICIPANT_SUBSCRIBED,
  MEETING_RECORDING_STARTED,
  MEETING_RECORDING_STOPPED,
  MEETING_PARTICIPANT_HAND_RAISED,
  MEETING_PARTICIPANT_HAND_RAISED_LIST
}
