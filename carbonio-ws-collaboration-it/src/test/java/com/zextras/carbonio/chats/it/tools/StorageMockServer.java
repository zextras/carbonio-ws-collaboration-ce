...
public class StorageMockServer extends ClientAndServer implements CloseableResource {
    ...
    when(request)
        .respond(
            response()
                ...
                .withHeaders(Header.header("Auth-Server", "127.0.0.1:8742")));
  }
  ...
  public void mockDownload(String fileId, String userId, FileMock fileMock, boolean success)
      throws IOException {
        ...
        .respond(
            response()
                ...
                .withHeaders(
                    Header.header(
                        "content-disposition",
                        "attachment; filename*=UTF-8''54614d1d-1513-4b21-a606-c45b4b226319"),
                    Header.header("content-type", fileMock.getMimeType()),
                    Header.header("content-length", String.valueOf(fileMock.getSize()))));
  }
  ...
  public void mockBulkDelete(
      List<String> requestIds, String userId, List<String> responseIds, boolean success) {
  ...
  public void mockCopyFile(
    ...
    responseBody.setSize(0L);
    HttpRequest request =
        getCopyFileRequest(sourceId, sourceUserId, destinationId, destinationUserId);
    clear(request);
    when(request)
        .respond(
            response()
