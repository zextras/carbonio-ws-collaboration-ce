package com.zextras.team.core.logging;
...
public class TeamLogger {
   ...
   *
   * @param state     log state {@link TeamLoggerLevel}
   * @param clazz     class from which the log comes
   * @param message   message to log
   * @param throwable exception to log
   */
  private static void log(TeamLoggerLevel state, Class<?> clazz, String message, Throwable throwable) {
    Logger logger = LoggerFactory.getLogger(clazz == null ? TeamLogger.class : clazz); //TODO check class
    switch (state) {
      case ERROR:
  ...
  public static void error(Class<?> clazz, String message, Throwable throwable) {
    log(TeamLoggerLevel.ERROR, clazz, message, throwable);
  }
  ...
  public static void warn(Class<?> clazz, String message, Throwable throwable) {
    log(TeamLoggerLevel.WARN, clazz, message, throwable);
  }
  ...
  public static void info(Class<?> clazz, String message, Throwable throwable) {
    log(TeamLoggerLevel.INFO, clazz, message, throwable);
  }
  ...
  public static void debug(Class<?> clazz, String message, Throwable throwable) {
    log(TeamLoggerLevel.DEBUG, clazz, message, throwable);
  }
  ...
  public static void trace(Class<?> clazz, String message, Throwable throwable) {
    log(TeamLoggerLevel.TRACE, clazz, message, throwable);
  }
}
