...
public class MeetingDatabaseExtension implements BeforeAllCallback, AfterEachCallback {

  private final static Namespace EXTENSION_NAMESPACE  = Namespace.create(MeetingDatabaseExtension.class);
