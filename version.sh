...
chats_api_file="carbonio-ws-collaboration-openapi/src/main/resources/chats/chats-api.yaml"
meeting_api_file="carbonio-ws-collaboration-openapi/src/main/resources/meeting/meeting-api.yaml"
main "$1" "$2"