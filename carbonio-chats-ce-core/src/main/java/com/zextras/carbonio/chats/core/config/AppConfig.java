...
public abstract class AppConfig {
  ...
  /**
   * Returns the configured environment type or an empty optional if it was not found.
   * N.B. The returned {@link Optional} should always be empty if the configuration was not found.
