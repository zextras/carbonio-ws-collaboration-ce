...
public class MockedAccount {
  ...
  private static final List<MockAccount> mockedAccounts = List.of(
    MockAccount.create("332a9527-3388-4207-be77-6d7e2978a723").name("Snoopy").email("snoopy@peanuts.com").token("6g2R31FDn9epUpbyLhZSltqACqd33K9qa0b3lsJL"),
    ...
    MockAccount.create("c91f0b6d-220e-408f-8575-5bf3633fc7f7").name("Linus van Pelt").email("linus.van.pelt@peanuts.com")
      .token("Cj5x9bgeU4SvvfoiA7zYJnYCH1hQHCgtRJY7MCIH"),
    MockAccount.create("ef196327-acf0-4888-b155-d42dcc659e4d").name("Peperita Patty").email("peperita.patty@peanuts.com")
      .token("EHh8T78Lr40Sr4D5ENGXvUunHmgdi8e9xVkBMMCy"),
    MockAccount.create("120bbfbe-b97b-44d0-81ac-2f23bc244878").name("Marcie Johnson").email("marcie.johnson@peanuts.com")
  ...
  public static MockAccount getAccount(int i) {
    return mockedAccounts.get(i % mockedAccounts.size());
  }
  ...
  public static class MockAccount extends Account {
    ...
    public static MockAccount create(UUID id) {
      return new MockAccount(id.toString());
    }
